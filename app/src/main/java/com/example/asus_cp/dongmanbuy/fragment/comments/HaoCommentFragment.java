...
public class HaoCommentFragment extends BaseFragment {
    ...
    private Good good;
    private String tag="HaoCommentFragment";
    private List<Comment> comments;
    private LinearLayout moRenLinearLayout;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.hao_comments_fragment_layout,null);
        listView= (ListView) v.findViewById(R.id.list_hao_comment);
