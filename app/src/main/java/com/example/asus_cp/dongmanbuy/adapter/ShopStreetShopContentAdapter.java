...
/**
 * 店铺街店铺列表的recycleview的适配器
 * Created by asus-cp on 2016-06-07.
 */
public class ShopStreetShopContentAdapter extends RecyclerView.Adapter{
    private Context context;
    private List<Good> goods;
    private LayoutInflater inflater;
    private ImageLoadHelper helper;

    public ShopStreetShopContentAdapter(Context context, List<Good> goods) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        imageLoader.get(goods.get(position).getGoodsImg(),listener);
