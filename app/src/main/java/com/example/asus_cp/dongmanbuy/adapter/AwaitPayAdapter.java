...
public class AwaitPayAdapter extends BaseAdapter{
    ...
    private static final String TAG = "AwaitPayAdapter";
    private Context mContext;
    private List<Good> goods;
    private LayoutInflater mInflater;
    private ImageLoadHelper helper;

    public AwaitPayAdapter(Context mContext, List<Good> goods) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v==null){
            v=mInflater.inflate(R.layout.item_layout_await_pay,null);
