...
public class ProductFragment extends BaseFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.prodcut_detail_layout,null);
        init(v);
        return v;
    }
...
//                            JSONObject jsonObject=jsonArray.getJSONObject(0);
    ...
    public void initView(View v) {
        //初始化view
        productBigPicImageView = (ImageView) v.findViewById(R.id.img_product_big_pic);
        productPicCountsTextView = (TextView) v.findViewById(R.id.text_product_pic_counts);
        isZiYingTextView = (TextView) v.findViewById(R.id.text_is_zi_ying);
        isZiYingLinearLayout= (LinearLayout) v.findViewById(R.id.ll_is_zi_ying);
        productNameTextView = (TextView) v.findViewById(R.id.text_product_name);
        shouCangLinearLayout = (LinearLayout) v.findViewById(R.id.ll_shou_cang);
        shouCangImageView= (ImageView) v.findViewById(R.id.img_shou_cang);
        shouCangTextView= (TextView) v.findViewById(R.id.text_shou_cang);
        benDianJiaGeTextView = (TextView) v.findViewById(R.id.text_ben_zhan_price);
        zheKouTextView = (TextView) v.findViewById(R.id.text_zhe_kou);
        marketPriceTextView = (TextView) v.findViewById(R.id.text_market_price);
        xiaoLiangTextView = (TextView) v.findViewById(R.id.text_xiao_liang);
        kuCunTextView = (TextView) v.findViewById(R.id.text_ku_cun);
        lingQuYouHuiQuanLinearLayout = (LinearLayout) v.findViewById(R.id.ll_ling_qu_you_hui_quan);
        youHuiQuanCountsTextView = (TextView) v.findViewById(R.id.text_you_hui_quan_counts);
        youHuiQuanOneTextView = (TextView) v.findViewById(R.id.text_you_hui_quan_one);
        youHuiQuanTwoTextView = (TextView) v.findViewById(R.id.text_you_hui_quan_two);
        suoZaiDiQuLayout = (RelativeLayout) v.findViewById(R.id.re_layout_suo_zai_di_qu);
        suoZaiDiQuTextView = (TextView) v.findViewById(R.id.text_suo_zai_di_qu);
        yunFeiTextView = (TextView) v.findViewById(R.id.text_yun_fei);
        yiXuanRelaytiveLayout = (RelativeLayout) v.findViewById(R.id.re_layout_yi_xuan);
        yiXuanProductTextView = (TextView) v.findViewById(R.id.text_yi_xuan_product);
        fuWuLineatLayout = (LinearLayout) v.findViewById(R.id.ll_fu_wu);
        huoDaoFuKuanOutLinearLayout= (LinearLayout) v.findViewById(R.id.ll_huo_dao_fu_kuan_product_detail);
        qiTianTuiHuoOutLinearLayout= (LinearLayout) v.findViewById(R.id.ll_qi);
        jiSuDaOutLinearLayout= (LinearLayout)v.findViewById(R.id.ll_ji_su_da_product_detail);
        seeProductDetailReLativeLayout = (RelativeLayout) v.findViewById(R.id.re_layout_product_detail);
        userCommentReLativeLayout = (RelativeLayout) v.findViewById(R.id.re_layout_user_commet);
        haoPingLvTextView = (TextView) v.findViewById(R.id.text_hao_ping_lv);
        pingLunShuTextView = (TextView) v.findViewById(R.id.text_comment_counts);
        xingOneImageView = (ImageView) v.findViewById(R.id.img_xing_one);
        xingTwoImageView = (ImageView) v.findViewById(R.id.img_xing_two);
        xingThreeImageView = (ImageView) v.findViewById(R.id.img_xing_three);
        xingFourImageView = (ImageView) v.findViewById(R.id.img_xing_four);
        xingFiveImageView = (ImageView) v.findViewById(R.id.img_xing_five);
        songXingPepleName = (TextView) v.findViewById(R.id.text_song_xing_people_name);
        commentTimeTextView = (TextView) v.findViewById(R.id.text_comment_time);
        commentContentTextView = (TextView) v.findViewById(R.id.text_commet_content);
        youTuPingJiaButton = (Button) v.findViewById(R.id.btn_you_tu_ping_jia);
        quanBuPingJiaButton = (Button) v.findViewById(R.id.btn_quan_bu_ping_jia);
        lianXiKeFuLinearLayout = (RelativeLayout) v.findViewById(R.id.ll_lian_xi_ke_fu);
        baoKuanXinPinRecyclerView = (RecyclerView) v.findViewById(R.id.recycle_view_bao_kuan_xin_pin);
        commentQuYu = (LinearLayout) v.findViewById(R.id.ll_comment_content);

        keFuLinearLayout = (LinearLayout) v.findViewById(R.id.ll_ke_fu);
        shoppingCarLinearLayout = (LinearLayout) v.findViewById(R.id.ll_shopping_car_product_detail);
        addToShoppingCarButton = (Button) v.findViewById(R.id.btn_add_to_shopping_car);
        buyAtOnceButton = (Button) v.findViewById(R.id.btn_buy_at_once);
        shoppingCarCountTextView= (TextView) v.findViewById(R.id.text_gou_wu_che_count);
        zanShiQueHuoLinearLayout= (LinearLayout) v.findViewById(R.id.ll_zan_shi_que_huo_product_detail);
        addToShoppingCarLinearLayout= (LinearLayout) v.findViewById(R.id.ll_add_to_shopping_car_product_detail);
        buyAtOnceLinearLayout= (LinearLayout) v.findViewById(R.id.ll_buy_at_once_product_detail);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.re_layout_suo_zai_di_qu://所在地区
                ...
                Intent areaIntent=new Intent(context,AreaActivity.class);
