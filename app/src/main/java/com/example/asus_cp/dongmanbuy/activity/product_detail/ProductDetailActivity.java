...
import com.example.asus_cp.dongmanbuy.fragment.ProductFragment;
...
public class ProductDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        daoHangImageView= (ImageView) findViewById(R.id.img_dao_hang_base_acitivity);
    ...
    private void init() {
        ...
        productPicAndGuiGeFragment =new ProductPicAndGuiGeFragment();
        commentFragment=new CommentFragment();
        fragmentManager=getSupportFragmentManager();

        //一次性把参数传完，注意setArguments（）调用的时机
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img_dao_hang_base_acitivity:
                finish();
                break;
    ...
    public ProductPicAndGuiGeFragment getProductPicAndGuiGeFragment() {
        return productPicAndGuiGeFragment;
    }
